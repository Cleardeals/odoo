...
class TestWebsiteLead(PortalLeadTestCase):
    ...
    def setUp(self):
        super().setUp()
        # The "Website Inquiry" source ships in lead_source_data.xml; ensure it
        # exists and has a known fallback RM regardless of the seed RM presence.
    ...
    def test_13_endpoint_stores_full_payload_in_raw_data(self):
        ...
        self.assertEqual(raw["inquiry_source"], "mobile_app")
